...
var TodoModel = __webpack_require__(10);
...
var ListView = __webpack_require__(13);
...
var __t,__p='',__j=Array.prototype.join,print=function(){__p+=__j.call(arguments,'');};
with(obj||{}){
__p+='<form>\n	<input type="text" name="text" id="id_text" class="form-control mb-3" placeholder="ToDo" value="'+
((__t=( text ))==null?'':_.escape(__t))+
'" />\n	<input type="text" name="assignee" id="id_assignee" class="form-control mb-3" placeholder="Assignee" value="'+
((__t=( assignee ))==null?'':_.escape(__t))+
'"/>\n	<hr class="mb-4">\n	<button class="btn btn-primary btn-xs btn-block" id="btn-add">Add Item</button>\n</form>';
}
return __p;
};
